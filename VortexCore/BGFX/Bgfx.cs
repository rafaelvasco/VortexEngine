...
namespace VortexCore
{
	public static unsafe partial class Bgfx
	{
		...
		public enum TopologyConvertMode
		{
			/// <summary>
		...
		public unsafe struct InitProps
		{
			public unsafe struct Limits
			{
		...
		public static extern unsafe void AttachmentInit(Attachment* _this, TextureHandle _handle, Access _access, ushort _layer, ushort _mip, byte _resolve);
		...
		public static extern unsafe VertexLayout* VertexLayoutBegin(VertexLayout* _this, RendererType _rendererType);
		...
		public static extern unsafe VertexLayout* VertexLayoutAdd(VertexLayout* _this, Attrib _attrib, byte _num, AttribType _type, bool _normalized, bool _asInt);
		...
		public static extern unsafe void VertexLayoutDecode(VertexLayout* _this, Attrib _attrib, byte* _num, AttribType* _type, bool* _normalized, bool* _asInt);
		...
		public static extern unsafe bool VertexLayoutHas(VertexLayout* _this, Attrib _attrib);
		...
		public static extern unsafe VertexLayout* VertexLayoutSkip(VertexLayout* _this, byte _num);
		...
		public static extern unsafe void VertexLayoutEnd(VertexLayout* _this);
		...
		public static extern unsafe void VertexPack(float _input, bool _inputNormalized, Attrib _attr, VertexLayout* _layout, void* _data, uint _index);
		...
		public static extern unsafe void VertexUnpack(float _output, Attrib _attr, VertexLayout* _layout, void* _data, uint _index);
		...
		public static extern unsafe void VertexConvert(VertexLayout* _dstLayout, void* _dstData, VertexLayout* _srcLayout, void* _srcData, uint _num);
		...
		public static extern unsafe ushort WeldVertices(ushort* _output, VertexLayout* _layout, void* _data, ushort _num, float _epsilon);
		...
		public static extern unsafe uint TopologyConvert(TopologyConvertMode _conversion, void* _dst, uint _dstSize, void* _indices, uint _numIndices, bool _index32);
		...
		public static extern unsafe void TopologySortTriList(TopologySort _sort, void* _dst, uint _dstSize, float _dir, float _pos, void* _vertices, uint _stride, void* _indices, uint _numIndices, bool _index32);
		...
		public static extern unsafe byte GetSupportedRenderers(byte _max, RendererType* _enum);
		...
		public static extern unsafe void InitCtor(InitProps* _init);
		...
		[return: MarshalAs(UnmanagedType.I1)]
		public static extern unsafe bool Init(InitProps* _init);
		...
		public static extern unsafe RendererType GetRendererType();
		...
		public static extern unsafe Caps* GetCaps();
		...
		public static extern unsafe Stats* GetStats();
		...
		public static extern unsafe Memory* MakeRef(void* _data, uint _size);
		...
		public static extern unsafe Memory* MakeRefRelease(void* _data, uint _size, IntPtr _releaseFn, void* _userData);
		...
		public static extern unsafe void SetDebug(uint _debug);
		...
		public static extern unsafe void DbgTextClear(byte _attr = 0, bool _small = false);
		...
		public static extern unsafe void DbgTextPrintf(ushort _x, ushort _y, byte _attr, [MarshalAs(UnmanagedType.LPStr)] string _format, [MarshalAs(UnmanagedType.LPStr)] string args);
		...
		public static extern unsafe void DbgTextVprintf(ushort _x, ushort _y, byte _attr, [MarshalAs(UnmanagedType.LPStr)] string _format, IntPtr _argList);
		...
		public static extern unsafe void DbgTextImage(ushort _x, ushort _y, ushort _width, ushort _height, void* _data, ushort _pitch);
		...
		public static extern unsafe IndexBufferHandle CreateIndexBuffer(Memory* _mem, ushort _flags);
		...
		public static extern unsafe void SetIndexBufferName(IndexBufferHandle _handle, [MarshalAs(UnmanagedType.LPStr)] string _name, int _len);
		...
		public static extern unsafe void DestroyIndexBuffer(IndexBufferHandle _handle);
		...
		public static extern unsafe VertexLayoutHandle CreateVertexLayout(VertexLayout* _layout);
		...
		public static extern unsafe void DestroyVertexLayout(VertexLayoutHandle _layoutHandle);
		...
		public static extern unsafe VertexBufferHandle CreateVertexBuffer(Memory* _mem, VertexLayout* _layout, ushort _flags);
		...
		public static extern unsafe void SetVertexBufferName(VertexBufferHandle _handle, [MarshalAs(UnmanagedType.LPStr)] string _name, int _len);
		...
		public static extern unsafe void DestroyVertexBuffer(VertexBufferHandle _handle);
		...
		public static extern unsafe DynamicIndexBufferHandle CreateDynamicIndexBuffer(uint _num, ushort _flags);
		...
		public static extern unsafe DynamicIndexBufferHandle CreateDynamicIndexBufferMem(Memory* _mem, ushort _flags);
		...
		public static extern unsafe void UpdateDynamicIndexBuffer(DynamicIndexBufferHandle _handle, uint _startIndex, Memory* _mem);
		...
		public static extern unsafe void DestroyDynamicIndexBuffer(DynamicIndexBufferHandle _handle);
		...
		public static extern unsafe DynamicVertexBufferHandle CreateDynamicVertexBuffer(uint _num, VertexLayout* _layout, ushort _flags);
		...
		public static extern unsafe DynamicVertexBufferHandle CreateDynamicVertexBufferMem(Memory* _mem, VertexLayout* _layout, ushort _flags);
		...
		public static extern unsafe void UpdateDynamicVertexBuffer(DynamicVertexBufferHandle _handle, uint _startVertex, Memory* _mem);
		...
		public static extern unsafe void DestroyDynamicVertexBuffer(DynamicVertexBufferHandle _handle);
		...
		public static extern unsafe uint GetAvailTransientIndexBuffer(uint _num);
		...
		public static extern unsafe uint GetAvailTransientVertexBuffer(uint _num, VertexLayout* _layout);
		...
		public static extern unsafe uint GetAvailInstanceDataBuffer(uint _num, ushort _stride);
		...
		public static extern unsafe void AllocTransientIndexBuffer(TransientIndexBuffer* _tib, uint _num);
		...
		public static extern unsafe void AllocTransientVertexBuffer(TransientVertexBuffer* _tvb, uint _num, VertexLayout* _layout);
		...
		[return: MarshalAs(UnmanagedType.I1)]
		public static extern unsafe bool AllocTransientBuffers(TransientVertexBuffer* _tvb, VertexLayout* _layout, uint _numVertices, TransientIndexBuffer* _tib, uint _numIndices);
		...
		public static extern unsafe void AllocInstanceDataBuffer(InstanceDataBuffer* _idb, uint _num, ushort _stride);
		...
		public static extern unsafe IndirectBufferHandle CreateIndirectBuffer(uint _num);
		...
		public static extern unsafe void DestroyIndirectBuffer(IndirectBufferHandle _handle);
		...
		public static extern unsafe ShaderHandle CreateShader(Memory* _mem);
		...
		public static extern unsafe ushort GetShaderUniforms(ShaderHandle _handle, UniformHandle* _uniforms, ushort _max);
		...
		public static extern unsafe void SetShaderName(ShaderHandle _handle, [MarshalAs(UnmanagedType.LPStr)] string _name, int _len);
		...
		public static extern unsafe void DestroyShader(ShaderHandle _handle);
		...
		public static extern unsafe ProgramHandle CreateProgram(ShaderHandle _vsh, ShaderHandle _fsh, bool _destroyShaders);
		...
		public static extern unsafe ProgramHandle CreateComputeProgram(ShaderHandle _csh, bool _destroyShaders);
		...
		public static extern unsafe void DestroyProgram(ProgramHandle _handle);
		...
		[return: MarshalAs(UnmanagedType.I1)]
		public static extern unsafe bool IsTextureValid(ushort _depth, bool _cubeMap, ushort _numLayers, TextureFormat _format, ulong _flags);
		...
		public static extern unsafe void CalcTextureSize(TextureInfo* _info, ushort _width, ushort _height, ushort _depth, bool _cubeMap, bool _hasMips, ushort _numLayers, TextureFormat _format);
		...
		public static extern unsafe TextureHandle CreateTexture(Memory* _mem, ulong _flags, byte _skip, TextureInfo* _info);
		...
		public static extern unsafe TextureHandle CreateTexture2d(ushort _width, ushort _height, bool _hasMips, ushort _numLayers, TextureFormat _format, ulong _flags, Memory* _mem);
		...
		public static extern unsafe TextureHandle CreateTexture2dScaled(BackbufferRatio _ratio, bool _hasMips, ushort _numLayers, TextureFormat _format, ulong _flags);
		...
		public static extern unsafe TextureHandle CreateTexture3d(ushort _width, ushort _height, ushort _depth, bool _hasMips, TextureFormat _format, ulong _flags, Memory* _mem);
		...
		public static extern unsafe TextureHandle CreateTextureCube(ushort _size, bool _hasMips, ushort _numLayers, TextureFormat _format, ulong _flags, Memory* _mem);
		...
		public static extern unsafe void UpdateTexture2d(TextureHandle _handle, ushort _layer, byte _mip, ushort _x, ushort _y, ushort _width, ushort _height, Memory* _mem, ushort _pitch);
		...
		public static extern unsafe void UpdateTexture3d(TextureHandle _handle, byte _mip, ushort _x, ushort _y, ushort _z, ushort _width, ushort _height, ushort _depth, Memory* _mem);
		...
		public static extern unsafe void UpdateTextureCube(TextureHandle _handle, ushort _layer, byte _side, byte _mip, ushort _x, ushort _y, ushort _width, ushort _height, Memory* _mem, ushort _pitch);
		...
		public static extern unsafe uint ReadTexture(TextureHandle _handle, void* _data, byte _mip);
		...
		public static extern unsafe void SetTextureName(TextureHandle _handle, [MarshalAs(UnmanagedType.LPStr)] string _name, int _len);
		...
		public static extern unsafe void* GetDirectAccessPtr(TextureHandle _handle);
		...
		public static extern unsafe void DestroyTexture(TextureHandle _handle);
		...
		public static extern unsafe FrameBufferHandle CreateFrameBuffer(ushort _width, ushort _height, TextureFormat _format, ulong _textureFlags);
		...
		public static extern unsafe FrameBufferHandle CreateFrameBufferScaled(BackbufferRatio _ratio, TextureFormat _format, ulong _textureFlags);
		...
		public static extern unsafe FrameBufferHandle CreateFrameBufferFromHandles(byte _num, TextureHandle* _handles, bool _destroyTexture);
		...
		public static extern unsafe FrameBufferHandle CreateFrameBufferFromAttachment(byte _num, Attachment* _attachment, bool _destroyTexture);
		...
		public static extern unsafe FrameBufferHandle CreateFrameBufferFromNwh(void* _nwh, ushort _width, ushort _height, TextureFormat _format, TextureFormat _depthFormat);
		...
		public static extern unsafe void SetFrameBufferName(FrameBufferHandle _handle, [MarshalAs(UnmanagedType.LPStr)] string _name, int _len);
		...
		public static extern unsafe TextureHandle GetTexture(FrameBufferHandle _handle, byte _attachment);
		...
		public static extern unsafe void DestroyFrameBuffer(FrameBufferHandle _handle);
		...
		public static extern unsafe UniformHandle CreateUniform([MarshalAs(UnmanagedType.LPStr)] string _name, UniformType _type, ushort _num);
		...
		public static extern unsafe void GetUniformInfo(UniformHandle _handle, UniformInfo* _info);
		...
		public static extern unsafe void DestroyUniform(UniformHandle _handle);
		...
		public static extern unsafe OcclusionQueryHandle CreateOcclusionQuery();
		...
		public static extern unsafe OcclusionQueryResult GetResult(OcclusionQueryHandle _handle, int* _result);
		...
		public static extern unsafe void DestroyOcclusionQuery(OcclusionQueryHandle _handle);
		...
		public static extern unsafe void SetPaletteColor(byte _index, float _rgba);
		...
		public static extern unsafe void SetPaletteColorRgba8(byte _index, uint _rgba);
		...
		public static extern unsafe void SetViewName(ushort _id, [MarshalAs(UnmanagedType.LPStr)] string _name);
		...
		public static extern unsafe void SetViewRect(ushort _id, ushort _x, ushort _y, ushort _width, ushort _height);
		...
		public static extern unsafe void SetViewRectRatio(ushort _id, ushort _x, ushort _y, BackbufferRatio _ratio);
		...
		public static extern unsafe void SetViewScissor(ushort _id, ushort _x, ushort _y, ushort _width, ushort _height);
		...
		public static extern unsafe void SetViewClear(ushort _id, ushort _flags, uint _rgba, float _depth, byte _stencil);
		...
		public static extern unsafe void SetViewClearMrt(ushort _id, ushort _flags, float _depth, byte _stencil, byte _c0, byte _c1, byte _c2, byte _c3, byte _c4, byte _c5, byte _c6, byte _c7);
		...
		public static extern unsafe void SetViewMode(ushort _id, ViewMode _mode);
		...
		public static extern unsafe void SetViewFrameBuffer(ushort _id, FrameBufferHandle _handle);
		...
		public static extern unsafe void SetViewTransform(ushort _id, void* _view, void* _proj);
		...
		public static extern unsafe void SetViewOrder(ushort _id, ushort _num, ushort* _order);
		...
		public static extern unsafe Encoder* EncoderBegin(bool _forThread);
		...
		public static extern unsafe void EncoderEnd(Encoder* _encoder);
		...
		public static extern unsafe void EncoderSetMarker(Encoder* _this, [MarshalAs(UnmanagedType.LPStr)] string _marker);
		...
		public static extern unsafe void EncoderSetState(Encoder* _this, ulong _state, uint _rgba);
		...
		public static extern unsafe ushort EncoderSetScissor(Encoder* _this, ushort _x, ushort _y, ushort _width, ushort _height);
		...
		public static extern unsafe void EncoderSetScissorCached(Encoder* _this, ushort _cache);
		...
		public static extern unsafe uint EncoderSetTransform(Encoder* _this, void* _mtx, ushort _num);
		...
		public static extern unsafe void EncoderSetTransformCached(Encoder* _this, uint _cache, ushort _num);
		...
		public static extern unsafe uint EncoderAllocTransform(Encoder* _this, Transform* _transform, ushort _num);
		...
		public static extern unsafe void EncoderSetUniform(Encoder* _this, UniformHandle _handle, void* _value, ushort _num);
		...
		public static extern unsafe void EncoderSetIndexBuffer(Encoder* _this, IndexBufferHandle _handle, uint _firstIndex, uint _numIndices);
		...
		public static extern unsafe void EncoderSetDynamicIndexBuffer(Encoder* _this, DynamicIndexBufferHandle _handle, uint _firstIndex, uint _numIndices);
		...
		public static extern unsafe void EncoderSetTransientIndexBuffer(Encoder* _this, TransientIndexBuffer* _tib, uint _firstIndex, uint _numIndices);
		...
		public static extern unsafe void EncoderSetVertexBuffer(Encoder* _this, byte _stream, VertexBufferHandle _handle, uint _startVertex, uint _numVertices, VertexLayoutHandle _layoutHandle);
		...
		public static extern unsafe void EncoderSetDynamicVertexBuffer(Encoder* _this, byte _stream, DynamicVertexBufferHandle _handle, uint _startVertex, uint _numVertices, VertexLayoutHandle _layoutHandle);
		...
		public static extern unsafe void EncoderSetTransientVertexBuffer(Encoder* _this, byte _stream, TransientVertexBuffer* _tvb, uint _startVertex, uint _numVertices, VertexLayoutHandle _layoutHandle);
		...
		public static extern unsafe void EncoderSetVertexCount(Encoder* _this, uint _numVertices);
		...
		public static extern unsafe void EncoderSetInstanceDataBuffer(Encoder* _this, InstanceDataBuffer* _idb, uint _start, uint _num);
		...
		public static extern unsafe void EncoderSetInstanceDataFromVertexBuffer(Encoder* _this, VertexBufferHandle _handle, uint _startVertex, uint _num);
		...
		public static extern unsafe void EncoderSetInstanceDataFromDynamicVertexBuffer(Encoder* _this, DynamicVertexBufferHandle _handle, uint _startVertex, uint _num);
		...
		public static extern unsafe void EncoderSetInstanceCount(Encoder* _this, uint _numInstances);
		...
		public static extern unsafe void EncoderSetTexture(Encoder* _this, byte _stage, UniformHandle _sampler, TextureHandle _handle, uint _flags);
		...
		public static extern unsafe void EncoderTouch(Encoder* _this, ushort _id);
		...
		public static extern unsafe void EncoderSubmit(Encoder* _this, ushort _id, ProgramHandle _program, uint _depth, bool _preserveState);
		...
		public static extern unsafe void EncoderSubmitOcclusionQuery(Encoder* _this, ushort _id, ProgramHandle _program, OcclusionQueryHandle _occlusionQuery, uint _depth, bool _preserveState);
		...
		public static extern unsafe void EncoderSubmitIndirect(Encoder* _this, ushort _id, ProgramHandle _program, IndirectBufferHandle _indirectHandle, ushort _start, ushort _num, uint _depth, bool _preserveState);
		...
		public static extern unsafe void EncoderSetComputeIndexBuffer(Encoder* _this, byte _stage, IndexBufferHandle _handle, Access _access);
		...
		public static extern unsafe void EncoderSetComputeVertexBuffer(Encoder* _this, byte _stage, VertexBufferHandle _handle, Access _access);
		...
		public static extern unsafe void EncoderSetComputeDynamicIndexBuffer(Encoder* _this, byte _stage, DynamicIndexBufferHandle _handle, Access _access);
		...
		public static extern unsafe void EncoderSetComputeDynamicVertexBuffer(Encoder* _this, byte _stage, DynamicVertexBufferHandle _handle, Access _access);
		...
		public static extern unsafe void EncoderSetComputeIndirectBuffer(Encoder* _this, byte _stage, IndirectBufferHandle _handle, Access _access);
		...
		public static extern unsafe void EncoderSetImage(Encoder* _this, byte _stage, TextureHandle _handle, byte _mip, Access _access, TextureFormat _format);
		...
		public static extern unsafe void EncoderDispatch(Encoder* _this, ushort _id, ProgramHandle _program, uint _numX, uint _numY, uint _numZ);
		...
		public static extern unsafe void EncoderDispatchIndirect(Encoder* _this, ushort _id, ProgramHandle _program, IndirectBufferHandle _indirectHandle, ushort _start, ushort _num);
		...
		public static extern unsafe void EncoderDiscard(Encoder* _this);
		...
		public static extern unsafe void EncoderBlit(Encoder* _this, ushort _id, TextureHandle _dst, byte _dstMip, ushort _dstX, ushort _dstY, ushort _dstZ, TextureHandle _src, byte _srcMip, ushort _srcX, ushort _srcY, ushort _srcZ, ushort _width, ushort _height, ushort _depth);
		...
		public static extern unsafe void RequestScreenShot(FrameBufferHandle _handle, [MarshalAs(UnmanagedType.LPStr)] string _filePath);
		...
		public static extern unsafe RenderFrameMode RenderFrame(int _msecs);
		...
		public static extern unsafe void SetPlatformData(PlatformData* _data);
		...
		public static extern unsafe InternalData* GetInternalData();
		...
		public static extern unsafe UIntPtr OverrideInternalTexturePtr(TextureHandle _handle, UIntPtr _ptr);
		...
		public static extern unsafe UIntPtr OverrideInternalTexture(TextureHandle _handle, ushort _width, ushort _height, byte _numMips, TextureFormat _format, ulong _flags);
		...
		public static extern unsafe void SetMarker([MarshalAs(UnmanagedType.LPStr)] string _marker);
		...
		public static extern unsafe void SetState(ulong _state, uint _rgba);
		...
		public static extern unsafe void SetCondition(OcclusionQueryHandle _handle, bool _visible);
		...
		public static extern unsafe void SetStencil(uint _fstencil, uint _bstencil);
		...
		public static extern unsafe ushort SetScissor(ushort _x, ushort _y, ushort _width, ushort _height);
		...
		public static extern unsafe void SetScissorCached(ushort _cache);
		...
		public static extern unsafe uint SetTransform(void* _mtx, ushort _num);
		...
		public static extern unsafe void SetTransformCached(uint _cache, ushort _num);
		...
		public static extern unsafe uint AllocTransform(Transform* _transform, ushort _num);
		...
		public static extern unsafe void SetUniform(UniformHandle _handle, void* _value, ushort _num);
		...
		public static extern unsafe void SetIndexBuffer(IndexBufferHandle _handle, uint _firstIndex, uint _numIndices);
		...
		public static extern unsafe void SetDynamicIndexBuffer(DynamicIndexBufferHandle _handle, uint _firstIndex, uint _numIndices);
		...
		public static extern unsafe void SetTransientIndexBuffer(TransientIndexBuffer* _tib, uint _firstIndex, uint _numIndices);
		...
		public static extern unsafe void SetVertexBuffer(byte _stream, VertexBufferHandle _handle, uint _startVertex, uint _numVertices);
		...
		public static extern unsafe void SetDynamicVertexBuffer(byte _stream, DynamicVertexBufferHandle _handle, uint _startVertex, uint _numVertices);
		...
		public static extern unsafe void SetTransientVertexBuffer(byte _stream, TransientVertexBuffer* _tvb, uint _startVertex, uint _numVertices);
		...
		public static extern unsafe void SetVertexCount(uint _numVertices);
		...
		public static extern unsafe void SetInstanceDataBuffer(InstanceDataBuffer* _idb, uint _start, uint _num);
		...
		public static extern unsafe void SetInstanceDataFromVertexBuffer(VertexBufferHandle _handle, uint _startVertex, uint _num);
		...
		public static extern unsafe void SetInstanceDataFromDynamicVertexBuffer(DynamicVertexBufferHandle _handle, uint _startVertex, uint _num);
		...
		public static extern unsafe void SetInstanceCount(uint _numInstances);
		...
		public static extern unsafe void SetTexture(byte _stage, UniformHandle _sampler, TextureHandle _handle, uint _flags);
		...
		public static extern unsafe void SubmitOcclusionQuery(ushort _id, ProgramHandle _program, OcclusionQueryHandle _occlusionQuery, uint _depth, bool _preserveState);
		...
		public static extern unsafe void SubmitIndirect(ushort _id, ProgramHandle _program, IndirectBufferHandle _indirectHandle, ushort _start, ushort _num, uint _depth, bool _preserveState);
		...
		public static extern unsafe void SetComputeIndexBuffer(byte _stage, IndexBufferHandle _handle, Access _access);
		...
		public static extern unsafe void SetComputeVertexBuffer(byte _stage, VertexBufferHandle _handle, Access _access);
		...
		public static extern unsafe void SetComputeDynamicIndexBuffer(byte _stage, DynamicIndexBufferHandle _handle, Access _access);
		...
		public static extern unsafe void SetComputeDynamicVertexBuffer(byte _stage, DynamicVertexBufferHandle _handle, Access _access);
		...
		public static extern unsafe void SetComputeIndirectBuffer(byte _stage, IndirectBufferHandle _handle, Access _access);
		...
		public static extern unsafe void SetImage(byte _stage, TextureHandle _handle, byte _mip, Access _access, TextureFormat _format);
		...
		public static extern unsafe void DispatchIndirect(ushort _id, ProgramHandle _program, IndirectBufferHandle _indirectHandle, ushort _start, ushort _num);
