...
namespace VortexCore
{
    ...
    {
        private static Dictionary<int, Key> keyMap;

        private static KeyState lastKeyState;
        ...
        public static void RemoveKey(int keyCode)
        {
            ...
            lastKeyState.ClearState(key);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static Key TranslatePlatformKey(int keyCode)
        {
            if(keyMap.TryGetValue(keyCode, out Key key))
            {
                return key;
            }
